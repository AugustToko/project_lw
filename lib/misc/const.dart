...
const DEFAULT_HTML_WALLPAPER_LIST = <Wallpaper>[
  ...
  Wallpaper.all('7', WallpaperType.HTML, 'TEST1', 'description', 'author', null,
      null, 1, 'AA', 'http://www.thewildernessdowntown.com/'),
  ...
  Wallpaper.all('9', WallpaperType.HTML, 'TEST1', 'description', 'author', null,
      null, 1, 'AA', 'https://www.uberviz.io/'),
  Wallpaper.all('10', WallpaperType.HTML, 'TEST1', 'description', 'author',
      null, null, 1, 'AA', 'https://blackpawn.com/demos/vrtx-01-compo-filler/'),
  Wallpaper.all('11', WallpaperType.HTML, 'TEST1', 'description', 'author',
      null, null, 1, 'AA', 'http://www.aaronkoblin.com/Aaronetrope/'),
];
